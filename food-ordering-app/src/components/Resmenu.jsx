...
const Resmenu=()=>{
    const { resId } = useParams();  //gets the resId from the url
    const dispatch=useDispatch();
    const cart=useSelector((store)=> store.cart.items);

    const ResInfo= useRestaurantData(resId); //gets restaurant data using custom hook useRestaurantData and passing resId as argument
        ...
        <div className="total-res-area dark:tw-bg-neutral-700">
            <div className="menu-wrapper">
                <div className="res-info dark:tw-bg-neutral-800 dark:tw-text-zinc-300">
                    <img src={"https://media-assets.swiggy.com/swiggy/image/upload/f_auto,q_auto,fl_lossy/" +cloudinaryImageId} alt=""/>
                            ...
                            return(
                                <div key={Resname+items?.card?.info?.description+ResavgRating+index} className="cover">
                                    <div className="res-menu-item-card dark:tw-bg-neutral-800">
                                        <img className="itemimg " src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_300,h_300,c_fit/" +
